/* Auto-generated by scripts/gen_syscall_table.sh — do not edit by hand. */
#ifndef SYSCALL_NAMES_H
#define SYSCALL_NAMES_H

#define SYSCALL_TABLE_MAX 461

static const char *syscall_names[SYSCALL_TABLE_MAX + 1] = {
    [0] = "read",
    [1] = "write",
    [2] = "open",
    [3] = "close",
...
static inline const char *syscall_name(long nr) {
    if (nr < 0 || nr > SYSCALL_TABLE_MAX || syscall_names[nr] == NULL)
        return "unknown";
